...
public class BitrixLogin {
    public static void main(String[] args) {
        ...
        //or we can do //*[@placeholder='PASSWORD'] star means any elements
        driver.findElement(By.xpath("//input[@class='login-btn']")).click();
        BrowserUtils.wait(3);
        //in order to find partial text  //*[contains(@title,'Activity Stream')]
        driver.close();

        //if we have a code without value or if dont have attribute we cna use start with
