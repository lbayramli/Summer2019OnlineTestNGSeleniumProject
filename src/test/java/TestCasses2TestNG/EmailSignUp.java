...
public class EmailSignUp {
    ...
    public void testCase6() {
        ...
        //Sign Up Email
        driver.findElement(By.name("full_name")).sendKeys("Lily Bay");
        ...
        Assert.assertEquals(ActualEmail, ExpectedEmail, "No email");
        ReceivedEmail.click();
        ...
        Assert.assertEquals(ActualSubject, ExpectedSubject, "Invalid");
